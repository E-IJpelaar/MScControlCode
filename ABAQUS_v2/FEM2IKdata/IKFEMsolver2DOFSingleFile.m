...
xlabel('x [mm]');ylabel('y [mm]') % axis names for convenience
...
plot(-x_opt_f*1e3,z_opt_f*1e3,'LineWidth',1.5)
plot(-x0(:,1)*1e3,x0(:,2)*1e3,'LineWidth',1.5)
