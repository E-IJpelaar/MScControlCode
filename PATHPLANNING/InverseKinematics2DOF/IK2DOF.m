...
L0     = 0.070;                  % undeformed length of actuator
rho = 1e-1;
%% IK parameters
...
x_d = [0.02;0.079];        % desired end-effector position (x,z) 
epsilon = 0.0001;          % max error norm
q0 = zeros(2*Nmode,1);     % initial guess
it_max = 2500;             % maximum amount of iterations
it = 0;                    % set iterations to zero
alpha = 1500;                % learning gain
