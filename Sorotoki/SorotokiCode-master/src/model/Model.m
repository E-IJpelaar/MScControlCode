...
%%% !!! %%% Quick fix   
% File = ['C:\Users\s159261\OneDrive - TU Eindhoven\Documents\GitHub\MScControlCode\Sorotoki\SorotokiCode-master\src\model\tools\solver\build_continious','/config.m'];
delete(File);
FID = fopen(File,'w');
