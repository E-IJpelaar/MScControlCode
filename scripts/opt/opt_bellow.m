...
%% generate mesh
msh = Mesh(sdf,'BdBox',[0,W,0,H],'NElem',350);
msh = msh.generate();

%% show generated mesh
fem = Fem(msh);
fem = fem.set('TimeStep',1/8,'ResidualNorm',1e-3,'VolumeInfill',0.4,...
              'Penal',4,'VolumetricPressure',true,'FilterRadius',0.75,...
              'Nonlinear',false,'ReflectionPlane',[1,1],'Repeat',[1 1 2 2],...
